<?php
	...
	class Dashboard extends CI_Controller
	{
		...
		public function index() {
			$data["title"]="Objekte";
			$data["objects"]=$this->model->getData("objects","all_array",$args=["where"=>["created_by"=>$this->session->userdata("userId")]]);
			...
			$this->load->view('objektmanager/index',$data); 
		}
