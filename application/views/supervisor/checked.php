                  ...
                  <table class="table table-striped table-bordered tbl">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th class="text-center">Kontrolldatum</th>
                    ...
                    <tr>
                 			...
                 			<td class="text-center"><?php echo $objects['object_name'];?></td>
											...
											<td class="text-center"><?php echo $objects['object_nl'];?></td>
						 					...
						 					<td class="text-center"><?
						 						echo date_format(date_create($objects['check_date']), 'd.m.Y');
						 						?>
						 					</td>	
                			<td class="text-center"><a href="<?=base_url('supervisor/checklisten/detail-view/'.$objects['id'])?>" data-toggle='tooltip' class="text-success" title="Details"><?php
                				$avg = $objects['avg'];

                				$avg_color = "";
                				
                				if ($avg>=5) {
                					$avg_color = " bg-rejected";
                				}
                				else if ($avg>=3) {
                					$avg_color = " bg-open";
                				}
                				else {
                					$avg_color = " bg-approved";
                				}
