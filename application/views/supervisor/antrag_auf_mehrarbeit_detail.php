											...
											<div class="tale-responsive">
												<table class="table details">
													...
													<tr>
														...
														<?php 
															if($item['approved']=="1") {
																echo $status = "<div class='text-success'>genehmigt</div>";
															} elseif($item['approved']=="0") {
																echo $status = "<div class='text-warning'>offen</div>";
															} elseif($item['approved']=="2") {
																echo $status = "<div class='text-danger'>abgelehnt</div>";
															}
														?>
														</td>
													</tr>
	...
	if($item['approved']=="2") {
		echo $status = "
													<tr>
														...
														<td><div>" . $item['not_approved_reason'] . "</div></td>
													</tr>
";
	}
?>
