                ...
                <div class="table-responsive">
                  <table class="table table-striped table-bordered tbl">
                    ...
                    <tr>
						...
						<?php 
						foreach($objektmanager	as $val){
						 	if($object['created_by']==$val['id']){?>
                        <td class="text-center"><?
						...
						$id = $object['id'];
						$fun = "del('".$id."')";?>
													<a href='#' data-toggle='tooltip' title='bearbeiten' class='text-info edit' data-edit='<?=$object['id']?>' ><span class='far fa-edit iconss'></span></a>
                         	<a href='#' data-toggle='tooltip' data-placement='top' onClick="<?=$fun?>"  title='löschen'  class='text-danger' ><span class='fa fa-trash-alt iconss'></span></a>
                        </td>
                    </tr>
                    <?php }} ?>
                    </tbody>
